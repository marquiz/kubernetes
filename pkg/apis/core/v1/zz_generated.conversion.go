...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ClassResourceInfo)(nil), (*core.ClassResourceInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ClassResourceInfo_To_core_ClassResourceInfo(a.(*v1.ClassResourceInfo), b.(*core.ClassResourceInfo), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ClassResourceInfo)(nil), (*v1.ClassResourceInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ClassResourceInfo_To_v1_ClassResourceInfo(a.(*core.ClassResourceInfo), b.(*v1.ClassResourceInfo), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ClassResourceInfo_To_core_ClassResourceInfo(in *v1.ClassResourceInfo, out *core.ClassResourceInfo, s conversion.Scope) error {
	out.Name = core.ClassResourceName(in.Name)
	out.Classes = *(*[]string)(unsafe.Pointer(&in.Classes))
	return nil
}

// Convert_v1_ClassResourceInfo_To_core_ClassResourceInfo is an autogenerated conversion function.
func Convert_v1_ClassResourceInfo_To_core_ClassResourceInfo(in *v1.ClassResourceInfo, out *core.ClassResourceInfo, s conversion.Scope) error {
	return autoConvert_v1_ClassResourceInfo_To_core_ClassResourceInfo(in, out, s)
}

func autoConvert_core_ClassResourceInfo_To_v1_ClassResourceInfo(in *core.ClassResourceInfo, out *v1.ClassResourceInfo, s conversion.Scope) error {
	out.Name = v1.ClassResourceName(in.Name)
	out.Classes = *(*[]string)(unsafe.Pointer(&in.Classes))
	return nil
}

// Convert_core_ClassResourceInfo_To_v1_ClassResourceInfo is an autogenerated conversion function.
func Convert_core_ClassResourceInfo_To_v1_ClassResourceInfo(in *core.ClassResourceInfo, out *v1.ClassResourceInfo, s conversion.Scope) error {
	return autoConvert_core_ClassResourceInfo_To_v1_ClassResourceInfo(in, out, s)
}
