...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClassResourceInfo) DeepCopyInto(out *ClassResourceInfo) {
	*out = *in
	if in.Classes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClassResourceInfo.
func (in *ClassResourceInfo) DeepCopy() *ClassResourceInfo {
	if in == nil {
		return nil
	}
	out := new(ClassResourceInfo)
	in.DeepCopyInto(out)
	return out
}
