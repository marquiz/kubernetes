...
// TODO: virtually identical code to the helpers in
// "k8s.io/pkg/api/v1/resource". Find a way to share the code.
package resource
...
func QOSResourcesTotalFromInfo(in []corev1.QOSResourceInfo) QOSResourcesTotal {
